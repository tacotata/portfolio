...
//modal(skills-more)
document.querySelector('.skillset__btn').onclick = function () {
  document.getElementById('skills-more').style.display = 'block'
}
document.querySelector('.skillset__btn--close').onclick = function () {
  document.querySelector('#skills-more').style.display = 'none'
}

//kakao

document.querySelector('.navbar__icon-sms').onmouseover = function () {
  document.querySelector('.kakao__wrap').style.display = 'block'
}

document.querySelector('.navbar__icon-sms').onmouseout = function () {
  document.querySelector('.kakao__wrap').style.display = 'none'
}
